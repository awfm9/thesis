...
\begin{tabular}{| l | l | l |}
  ...
  \hline
    Content insertion & Illegal content insertion & Accessibility\\
  \hline
    Content insertion & Data growth acceleration & Accessibility\\
  \hline

  \multicolumn{3}{| l |}{\underline{\smash{A.3.2 Project Organization}}}\\
  \hline
     Governance structure & Change consensus rules & Stability\\
  \hline
     Governance structure & Block project progress & Accessibility\\
  \hline
     Community influence & Personality cult & --\\
  \hline
     Community influence & Social media manipulation & --\\
  \hline
