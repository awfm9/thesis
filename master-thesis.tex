...
\begin{tabular}{| l | l | l |}
  ...
  \hline
    \textit{Censoring Transactions} & Throttle \& block transactions & Accessibility\\
  \hline
    \textit{Rewriting History} & Replace blockchain history version & Validity\\
  \hline
  ...
  \hline
  \multicolumn{3}{| l |}{\underline{A.3.1 Out-Of-Band Incentives}}\\
  \hline
